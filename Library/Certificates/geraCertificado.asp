...
"				coberturasplanos.planoid IN (SELECT top 1 id from planos where  (coalesce(publicado,0) = 1  or coalesce(operador,0) = 1  or  familiar='1') and coalesce(ageID,0)=0 and (nPlano ='"&plano_N&"'  )    )  " & _
"			    OR " & _
"				coberturasplanos.planoid IN (SELECT top 1 id from planos where  (coalesce(publicado,0) = 1  or coalesce(operador,0) = 1  or  familiar='1') and coalesce(ageID,0)=0   "&sql_cob_upgrade&"  )  " & _
"			    OR " & _
